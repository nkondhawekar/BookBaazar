...
from backend.buyer.buyer import buyers
from backend.sellers.seller import sellers
from backend.bookstore_manager.manager import managers
from backend.admin.admin import admins
import os
...
def create_app():
    ...
    app.register_blueprint(simple_routes, url_prefix='/sim')
