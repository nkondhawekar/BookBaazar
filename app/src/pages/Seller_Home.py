...
if st.button("My Listings"):
    st.experimental_set_query_params(page="11_Seller_MyListings")
    st.experimental_rerun()
if st.button("Price Recommendation"):
    st.experimental_set_query_params(page="12_Seller_PriceRecommendation")
    st.experimental_rerun()
if st.button("Update Listing Status"):
    st.experimental_set_query_params(page="13_Seller_UpdateListing")
    st.experimental_rerun()
